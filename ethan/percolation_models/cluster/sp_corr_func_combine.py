...
Combines all ~100 SP correlation functions generated at a particular bond probability into an averaged file
"""
import sys
import os
import numpy as np
...
np.save(f'./sp_corr_func_fill_averaged_prob={prob}_jobid={jobids[0]}', np.array([dists_master[0], cf_master_mean]))
