...
# ============================================================
#  run_bdd_all.sh — One command to generate all BDD aggregates
#
#  Must be executed from your $HOME directory (which contains scratch/)
#  and the script bnd_dd.py must be in the same directory as this bash script.
#
#  USAGE:
#    bash run_bdd_all.sh "<WINDOWS_CSV>" "<SITEPERC_P>"
#
#  EXAMPLE:
#    bash clouds/data_processing_scripts/analysis/run_bdd_all.sh "03:00-04:00,04:00-05:00,05:00-06:00,07:00-08:00,08:00-09:00,09:00-10:00,11:00-12:00,alltimes" 0.4074
#
#  This runs:
...
#
#  Outputs go to: $HOME/scratch/all_clouds_data/analysis/bd_distribution/
# ============================================================
...
SCRIPT_PATH="${SCRIPT_DIR}/bnd_dd.py"

# ---- sanity checks ----
if [[ ! -f "$SCRIPT_PATH" ]]; then
  echo "[ERROR] bnd_dd.py not found next to run_bdd_all.sh"
...
echo "[DONE] All BDD runs complete."
