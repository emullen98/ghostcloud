...
ccdfx_30G, ccdfy_30G = hs.load_pa(loc_30G)[2:4]
ccdfx_40G, ccdfy_40G = hs.load_pa(loc_40G)[2:4]
ccdfx_50G, ccdfy_50G = hs.load_pa(loc_50G)[2:4]
ccdfx_60G, ccdfy_60G = hs.load_pa(loc_60G)[2:4]
...
ax.set_title('Area CCDF for all thresholds')
