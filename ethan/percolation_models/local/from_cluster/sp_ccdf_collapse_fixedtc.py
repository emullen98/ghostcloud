...
Take site percolation CCDFs generated in the cluster and collapse them.
...
fig1.savefig(f'./sp_perim_ccdf_collapse_belowpc_s=50000_kappa={kappa_perim}_sigma={sigma_perim}.pdf')
...
fig2.savefig(f'./sp_perim_ccdf_collapse_abovepc_s=50000_kappa={kappa_perim}_sigma={sigma_perim}.pdf')
...
fig3.savefig(f'./sp_area_ccdf_collapse_belowpc_s=50000_kappa={kappa_area}_sigma={sigma_area}.pdf')
...
fig4.savefig(f'./sp_area_ccdf_collapse_abovepc_s=50000_kappa={kappa_area}_sigma={sigma_area}.pdf')
